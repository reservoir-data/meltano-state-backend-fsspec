...
from .settings import (
    ...
    SFTP_HOST as SFTP_HOST,
    SFTP_PORT as SFTP_PORT,
    SFTP_USERNAME as SFTP_USERNAME,
    SFTP_PASSWORD as SFTP_PASSWORD,
    SFTP_PRIVATE_KEY as SFTP_PRIVATE_KEY,
    SFTP_PRIVATE_KEY_FILE as SFTP_PRIVATE_KEY_FILE,
    SFTP_PRIVATE_KEY_PASS as SFTP_PRIVATE_KEY_PASS,
)
